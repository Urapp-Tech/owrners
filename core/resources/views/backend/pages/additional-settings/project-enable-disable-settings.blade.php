...
@section('title', __('Enable Disable Gigs'))
@section('style')
    <x-media.css/>
@endsection
@section('content')
                ...
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        <div class="customMarkup__single__item__flex">
                            <h4 class="customMarkup__single__title">{{ __('Enable Disable Gigs') }}</h4>
                        </div>
                        <x-validation.error />
                        <div class="customMarkup__single__inner mt-4">
                            ...
                            <form action="{{route('admin.project.enable.disable.settings')}}" method="post">
                                ...
                                <div class="single-input my-5">
                                    <label class="label-title">{{ __('Enable/Disable Gigs') }}</label>
