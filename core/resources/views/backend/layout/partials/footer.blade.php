    ...
    (function($){
        ...
        $(document).on('click','.swal_delete_button',function(e){
            ...
            Swal.fire({
                ...
                confirmButtonText: "<span>{{__('Yes, Delete it!')}}</span>"
            }).then((result) => {
        ...
        $(document).on('click','.swal_delete_button_restore',function(e){
            ...
            Swal.fire({
                ...
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                confirmButtonText: "<span>{{__('Yes, Restore it!')}}</span>"
            }).then((result) => {
                if (result.isConfirmed) {
        ...
        $(document).on('click','.swal_status_change_button',function(e){
            ...
            Swal.fire({
                ...
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                confirmButtonText: "<span>{{__('Yes, Change it!')}}</span>"
            }).then((result) => {
                if (result.isConfirmed) {
                    $(this).next().find('.swal_form_submit_btn').trigger('click');
                }
        ...
        $(document).on('click','.reject_project',function(e){
            ...
            Swal.fire({
                ...
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                confirmButtonText: "<span>{{__('Yes, Reject it!')}}</span>"
            }).then((result) => {
                if (result.isConfirmed) {
                    $(this).next().find('.swal_form_submit_btn').trigger('click');
                }
        ...
        $(document).on('click','.swal_disable_2fa_button',function(e){
            ...
            Swal.fire({
                ...
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                confirmButtonText: "<span>{{__('Yes, disable it!')}}</span>"
            }).then((result) => {
                if (result.isConfirmed) {
                    $(this).next().find('.swal_form_submit_btn').trigger('click');
                }
        ...
        $(document).on('click','.swal_email_verify_button',function(e){
            ...
            Swal.fire({
                ...
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                confirmButtonText: "<span>{{__('Yes, verify it!')}}</span>"
            }).then((result) => {
                if (result.isConfirmed) {
                    $(this).next().find('.swal_form_submit_btn').trigger('click');
                }
