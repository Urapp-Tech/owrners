        ...
        <div class="preview-area section-bg-2 pat-10 pab-100">
            <div class="container">
                <div class="row g-4">
                    ...
                    @endif
                    <div class="col-lg-12">
                        <h3> Results for <strong>{{ $search_query }}</strong></h3>
                    </div>
                    <div class="col-lg-12">
                        <div class="col-12">
                            <div class="shop-icon">
                            ...
                            @include('frontend.pages.search-projects.filters')
                        ...
                        <div class="col-12 mt-5">
                            <div class="shop-contents-wrapper-right search_subcategory_result">
                                @include('frontend.pages.search-projects.search-keywords-result')
                            </div>
                        </div>
                    </div>
                </div>
...
@section('script')
    @include('frontend.pages.search-projects.search-project-filter-js')
