        ...
        $(document).ready(function () {
            ...
            $(document).on('change', '#country , #type , #level , #duration', function() {
                ...
                $.ajax({
                    ...
                    method:'GET',
                    data:{country:country,type:type,level:level,min_price:min_price,max_price:max_price,duration:duration,subcategory:subcategory,  search: search_input},
            ...
            $(document).on('click', '.pagination a', function(e){
                ...
                jobs(page,country,subcategory,type,level,min_price,max_price,duration, search_input);
            });
            function jobs(page,country,subcategory,type,level,min_price,max_price,duration, search){
                $.ajax({
                    url:"{{ route('subcategory.jobs.pagination').'?page='}}" + page,
                    method:'GET',
                    data:{country:country,subcategory:subcategory,type:type,level:level,min_price:min_price,max_price:max_price,duration:duration, search:search},
                    success:function(res){
                        if(res.status=='nothing'){
