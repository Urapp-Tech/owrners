        ...
        $(document).ready(function () {
            ...
            $(document).on('change', '#country , #type , #level , #duration', function() {
                ...
                $.ajax({
                    ...
                    method:'GET',
                    data:{country:country,type:type,level:level,min_price:min_price,max_price:max_price,duration:duration, search: search_input},
            ...
            $(document).on('click', '.pagination a', function(e){
                ...
                let duration = $('#duration').val();
                let search_input = $('#search_input').val();
                jobs(page,country,type,level,min_price,max_price,duration, search_input);
            });
            function jobs(page,country,type,level,min_price,max_price,duration, search){
                $.ajax({
                    url:"{{ route('jobs.pagination').'?page='}}" + page,
                    method:'GET',
                    data:{country:country,type:type,level:level,min_price:min_price,max_price:max_price,duration:duration, search: search},
                    success:function(res){
                        if(res.status=='nothing'){
