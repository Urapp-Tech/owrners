        ...
        @foreach($projects as $project)
            @if(Auth::guard('web')->check() && Auth::guard('web')->user()->user_type == 2 && Auth::guard('web')->user()->username==$username)
                <div class="col-xxl-6 mb-3">
                    ...
                    <div class="single-project project-catalogue h-100">
                        <div class="">
                            ...
                            <div class="single-project-content project-catalogue-contents mt-0">
                                ...
                                <div class="project-catalogue-bottom flex-between mt-3">
                                    @if($project->basic_discount_charge != null && $project->basic_discount_charge > 0)
                                        <span class="single-project-content-price w-100"> {{ amount_with_currency_symbol($project->basic_discount_charge) ?? '' }} <s>{{ amount_with_currency_symbol($project->basic_regular_charge) ?? '' }}</s> </span>
                                    @else
                                        <span class="single-project-content-price w-100"> {{ amount_with_currency_symbol($project->basic_regular_charge) ?? '' }}</span>
                                    @endif
