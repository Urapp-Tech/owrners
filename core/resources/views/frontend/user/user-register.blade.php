        ...
        <div class="row gy-5 align-items-center justify-content-between">
            <div class="col-lg-6">
                <div class="px-5">
                    ...
                    <span class="account already-account color-light mt-4 "> {{ __('Already have an account?') }} <a class="color-one" href="{{ route('user.login') }}"> {{ __('Login') }} </a>
                    </span>
                </div>
            </div>
            ...
            <div class="col-lg-5">
                <div class="login-wrapper">
                    <div class="login-wrapper-contents">
                        ...
                        <form class="login-wrapper-form custom-form" method="post" action="{{ route('user.register') }}">
                            @csrf
