            ...
            @if (Auth::guard('web')->check())
                @if (Auth::guard('web')->user()->user_type == 2)
                    <ul class="profile-settings-menu-list">
                        ...
                        @endif
                        <li class="profile-settings-menu-item">
                            <a href="{{ route('freelancer.analytics.overview') }}" class="profile-settings-menu-item-link">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                    <path d="M16.4583 15.877H15.625V5.87695C15.626 5.71143 15.5776 5.54938 15.4861 5.41144C15.3946 5.27351 15.2641 5.16595 15.1112 5.10248C14.9584 5.039 14.7901 5.0225 14.6278 5.05505C14.4655 5.08761 14.3166 5.16776 14.2 5.28529L9.79167 9.70195L7.05 6.95195C6.90272 6.80441 6.70549 6.71743 6.49722 6.70818C6.28896 6.69892 6.08479 6.76806 5.925 6.90195L2.29167 9.92695V7.92695L6.40833 4.50195L9.2 7.29362C9.35614 7.44883 9.56734 7.53595 9.7875 7.53595C10.0077 7.53595 10.2189 7.44883 10.375 7.29362L15.375 2.29362C15.5115 2.1342 15.5829 1.92914 15.5748 1.71941C15.5667 1.50968 15.4797 1.31073 15.3313 1.16232C15.1829 1.01391 14.9839 0.926961 14.7742 0.91886C14.5645 0.910759 14.3594 0.982098 14.2 1.11862L9.79167 5.53529L7.05 2.78529C6.90272 2.63775 6.70549 2.55076 6.49722 2.54151C6.28896 2.53225 6.08479 2.60139 5.925 2.73529L2.29167 5.76029V1.71029C2.29167 1.48927 2.20387 1.27731 2.04759 1.12103C1.89131 0.96475 1.67935 0.876953 1.45833 0.876953C1.23732 0.876953 1.02536 0.96475 0.869078 1.12103C0.712797 1.27731 0.625 1.48927 0.625 1.71029V16.7103C0.625 16.9313 0.712797 17.1433 0.869078 17.2995C1.02536 17.4558 1.23732 17.5436 1.45833 17.5436H16.4583C16.6793 17.5436 16.8913 17.4558 17.0476 17.2995C17.2039 17.1433 17.2917 16.9313 17.2917 16.7103C17.2917 16.4893 17.2039 16.2773 17.0476 16.121C16.8913 15.9647 16.6793 15.877 16.4583 15.877Z" fill="#667085"/>
                                    </svg>
                        ...
                        <li class="profile-settings-menu-item">
                            <a href="{{ route('freelancer.projects.all') }}" class="profile-settings-menu-item-link">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path
                                            d="M17 22.75H7C3.56 22.75 1.25 20.44 1.25 17V12C1.25 8.92 3.15 6.69001 6.1 6.32001C6.38 6.28001 6.69 6.25 7 6.25H17C17.24 6.25 17.55 6.26 17.87 6.31C20.82 6.65 22.75 8.89 22.75 12V17C22.75 20.44 20.44 22.75 17 22.75ZM7 7.75C6.76 7.75 6.53 7.76999 6.3 7.79999C4.1 8.07999 2.75 9.68 2.75 12V17C2.75 19.58 4.42 21.25 7 21.25H17C19.58 21.25 21.25 19.58 21.25 17V12C21.25 9.66 19.88 8.05001 17.66 7.79001C17.42 7.75001 17.21 7.75 17 7.75H7Z"
