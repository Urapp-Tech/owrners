    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            $(document).on('click', '.level_rules_modal', function(e){
                ...
                let max_gigs = $(this).data('max-gigs');
                ...
                $('#LevelRulesModal #max_gigs').val(max_gigs);
            });
            ...
            $(document).on('click','.setup_level_rules',function(){
                ...
                let max_gigs = $('#LevelRulesModal #max_gigs').val();


                if(period == '' || avg_rating == '' || earning == '' || total_order == '' || max_gigs == ''){
                ...
                if(max_gigs < 1){
                    toastr_warning_js("{{ __('Freelancer must be able to do at least 1 gig') }}");
                    return false;
                }
            })
