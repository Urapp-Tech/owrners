...
@section('title', __('Gig Edit Email'))
@section('style')
                ...
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        <div class="customMarkup__single__item__flex">
                            <h4 class="customMarkup__single__title">{{ __('Gig Edit Email') }}</h4>
                        </div>
                        ...
                        <div class="customMarkup__single__inner mt-4">
                            ...
                            <form action="{{route('admin.user.project.edit')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <x-form.text
                                    ...
                                    :value="get_static_option('project_edit_email_subject') ?? __('Gig Edit Email')"
                                />
                                <x-form.summernote
