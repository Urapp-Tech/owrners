...
class CategoryProjectTwo extends PageBuilderBase
{
    ...
    public function frontend_render()
    {
        ...
        return  $this->renderBlade('categories.category-projects-two',compact(['title','items','slider_button_text','padding_top','padding_bottom','section_bg','project_categories']));
    }

    public function addon_title()
    {
        return __('Category Project: 02');
    }
}
